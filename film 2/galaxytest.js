...
let mentioned_locations = [['Coruscant', 'Naboo', 'Coruscant', 'Naboo', 'Naboo'],
 [],
 [],
 ['Naboo'],
 [],
...
function setup() {
    ...
    for (i = 0; i < shipdata.length; i++) {
        ...
        ships.push(new Ship(current_ship.journey[0].start[0], current_ship.journey[0].start[1], c, current_ship, i*5, i*5))
    }
